...
namespace CeresBeach\Providers;
...
/**
 * Class CeresBeachServiceProvider
 * @package CeresBeach\Providers
 */
class CeresBeachServiceProvider extends ServiceProvider
{
    const PRIORITY = 0;
    ...
    public function boot(Twig $twig, Dispatcher $dispatcher, ConfigRepository $config)
    {
        ...
        $enabledOverrides = explode(", ", $config->get("CeresBeach.templates.override"));

        // Override partials
        $dispatcher->listen('IO.init.templates', function (Partial $partial) use ($enabledOverrides)
        {
            pluginApp(Container::class)->register('CeresBeach::PageDesign.Partials.Header.NavigationList.twig', NavigationCacheSettings::class);
            pluginApp(Container::class)->register('CeresBeach::PageDesign.Partials.Header.SideNavigation.twig', SideNavigationCacheSettings::class);
            ...
            {
                $partial->set('head', 'CeresBeach::PageDesign.Partials.Head');
            }

            if (in_array("header", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('header', 'CeresBeach::PageDesign.Partials.Header.Header');
            }

            if (in_array("page_design", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('page-design', 'CeresBeach::PageDesign.PageDesign');
            }

            if (in_array("footer", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('footer', 'CeresBeach::PageDesign.Partials.Footer');
            }
        ...
        if (in_array("homepage", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Homepage.Homepage');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Category.Item.CategoryItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("basket", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Basket.Basket');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Checkout.Checkout');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Customer.Login');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Customer.Register');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::Item.SingleItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_view", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::ItemList.ItemListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::MyAccount.MyAccount');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('CeresBeach::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
    }
